...
<ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400">
    <li class="me-2">
        <a href="#" aria-current="{{ request()->is('budgets*') ? 'page' : 'false' }}" class="{{ request()->is('budgets*') ? $active : $idle}}">Budget</a>
    </li>
    <li class="me-2">
        <a href="#" aria-current="{{ request()->is('budgets/income*') ? 'page' : 'false' }}" class="{{ request()->is('budgets/income*') ? $active : $idle}}">Income</a>
    </li>
</ul>

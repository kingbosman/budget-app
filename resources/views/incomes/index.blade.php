        ...
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <div class ="mt-5 mb-3 flex flex-1">
                ...
                <div class ="flex flex-1 sm:items-stretch justify-end">
                    <a href="{{ route('budgets.edit', $budget) }}" class="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">Settings</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        @foreach($tests as $test)
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <input type="text" name="amount" id="amount" class="bg-gray-800 text-gray-100 text-xs hover:border-blue-800" value="100">
                                </td>
                                <td>
